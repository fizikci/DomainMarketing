...
namespace DealerSafe2.DTO.ServiceClient
{
    public abstract class BaseAPI
    {
        ...
        private static string winAppSelectedLang = "en";
        ...
        public string SelectedLang
        {
            get
            {
                return HttpContext.Current != null ? (string)HttpContext.Current.Session["SelectedLang"] : winAppSelectedLang;
            }
            set
            {
                if (HttpContext.Current != null)
                    HttpContext.Current.Session["SelectedLang"] = value;
                else
                    winAppSelectedLang = value;
            }
        }
        public void SetSelectedLang(string l){SelectedLang = l;}
        ...
        protected T Call<T, K>(K request, string methodName)
        {
            ...
            serviceRequest.Lang = SelectedLang;
