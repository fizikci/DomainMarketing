...
<list-header title="DMAuction"></list-header>
...
<table class="table table-striped table-bordered table-hover">
	<thead>
		<tr>
			...
			<th column-header="Smallest Bid" field="SmallestBid"></th>
			<th column-header="Biggest Bid" field="BiggestBid"></th>
			<th column-header="Payment Amount" field="PaymentAmount"></th>
			<th column-header="Buyer Member" field="BuyerMemberName"></th>
			<th column-header="Payment Status" field="PaymentStatus"></th>
			<th></th>
		</tr>
	</thead>
	<tbody>
		<tr ng-repeat="entity in list" ng-class="{deleted:entity.IsDeleted}">
			...
			<td>{{entity.SmallestBid}}</td>
			<td>{{entity.BiggestBid}}</td>
			<td>{{entity.PaymentAmount}}</td>
			<td link-to-parent="BuyerMember">{{entity.BuyerMemberName}}</td>
